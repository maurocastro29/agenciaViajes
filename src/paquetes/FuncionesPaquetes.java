 ...
 * @author 
 */
public class FuncionesPaquetes {
    
    public FuncionesPaquetes(){
        
    }
    public void guardarDatosArchivo(String nombreA, Destino destino){
        try{
            FileWriter fw = new FileWriter((nombreA+".txt"), true);
    ...
    public DefaultTableModel llenarTablaDestinos(String nombre){
